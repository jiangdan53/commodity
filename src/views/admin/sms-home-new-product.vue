<template>
    ...
    <el-dialog v-model="dialogFormVisible" title="编辑">
        <el-form :model="adCate">
            <el-form-item label="新品id" :label-width="formLabelWidth">
                <el-input v-model="adCate.productId" autocomplete="off" />
            </el-form-item>
            <el-form-item label="新品名称" :label-width="formLabelWidth">
    ...
    <el-dialog v-model="dialogFormVisibleById" title="查询">
        <el-form :model="adCate">
            <el-form-item label="请输入新品id" :label-width="formLabelWidth">
                <el-input v-model="searchText" placeholder="按新品id查询，请输入新品id" autocomplete="off" />
            </el-form-item>
        </el-form>
  ...
  import {adTaskPage,adTaskDelId,adTaskEdit,couponOne,adTaskAdd} from "../../http/sms-home-new-product";
