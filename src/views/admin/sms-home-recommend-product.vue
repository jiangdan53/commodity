<template>
    ...
    <el-dialog v-model="dialogFormVisible" title="编辑">
        <el-form :model="adCate">
            <el-form-item label="推荐品id" :label-width="formLabelWidth">
                <el-input v-model="adCate.productId" autocomplete="off" />
            </el-form-item>
            <el-form-item label="推荐品名称" :label-width="formLabelWidth">
    ...
    <el-dialog v-model="dialogFormVisibleById" title="查询">
        <el-form :model="adCate">
            <el-form-item label="请输入推荐品id" :label-width="formLabelWidth">
                <el-input v-model="searchText" placeholder="按推荐品id查询，请输入推荐品id" autocomplete="off" />
            </el-form-item>
        </el-form>
  ...
  import {adTaskPage,adTaskDelId,adTaskEdit,couponOne,adTaskAdd} from "../../http/sms-home-recommend-product";
