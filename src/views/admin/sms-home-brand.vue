<template>
    ...
    <el-dialog v-model="dialogFormVisibleById" title="查询">
        <el-form :model="adCate">
            <el-form-item label="请输入品牌id" :label-width="formLabelWidth">
                <el-input v-model="searchText" placeholder="按品牌id查询，请输入品牌id" autocomplete="off" />
            </el-form-item>
        </el-form>
  ...
  import {adTaskPage,adTaskDelId,adTaskEdit,couponOne,adTaskAdd} from "../../http/sms-home-brand";
