<template>
  ...
  import {subjectadTaskPage,subjectadTaskDelId,subjectadTaskEdit,subjectcouponOne,subjectadTaskAdd} from "../../http/usersubject";
  ...
  export default defineComponent({
    ...
    methods: {
        ...
        getAdCatesPage(current) {
            ...
            subjectadTaskPage(data).then(res => {
                console.log(res);
        ...
        del(id) {
            ...
            subjectadTaskDelId(params).then(res => {
                if (res.success) {
        ...
        getById(id) {
            ...
            subjectcouponOne(params).then(res => {
        ...
        save() {
            ...
            if (adcate.id == 0) {
                subjectadTaskAdd(adcate).then(res => {
                    if (res.success) {
                        //刷新页面
                ...
                subjectadTaskEdit(adcate).then(res => {
                    if (res.success) {
                        //刷新页面
                        this.dialogFormVisible = false;
                        this.getAdCatesPage(this.page.current)
