<template>
    ...
    <div class="adCates">
        ...
        <el-table :data="adCates" style="width: 100%">
            ...
            <el-table-column prop="subjectId" label="推荐专题id" />
            <el-table-column prop="subjectName" label="推荐专题名称" />
    ...
    <el-dialog v-model="dialogFormVisible" title="编辑">
        <el-form :model="adCate">
            <el-form-item label="推荐专题id" :label-width="formLabelWidth">
                <el-input v-model="adCate.subjectId" autocomplete="off" />
            </el-form-item>
            <el-form-item label="推荐专题名称" :label-width="formLabelWidth">
                <el-input v-model="adCate.subjectName" autocomplete="off" />
            </el-form-item>
    ...
    <el-dialog v-model="dialogFormVisibleById" title="查询">
        <el-form :model="adCate">
            <el-form-item label="请输入推荐专题id" :label-width="formLabelWidth">
                <el-input v-model="searchText" placeholder="按推荐专题id查询，请输入推荐专题id" autocomplete="off" />
            </el-form-item>
        </el-form>
  ...
  import {adTaskPage,adTaskDelId,adTaskEdit,couponOne,adTaskAdd} from "../../http/sms-home-recommend-subject";
